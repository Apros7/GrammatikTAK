...
class Error():
    def __init__(self, wrong_word: str = None, right_word: str = None, indexes: list = None, 
        ...
        self.check_right_word()
        self.indexes = indexes
        self.description = description
        self.set_type(type)
    
    def check_right_word(self):
        if type(self.right_word) is list: 
            self.right_word = self.right_word[:3] if len(self.right_word) > 3 else self.right_word
