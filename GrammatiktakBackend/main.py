...
def correct_input(input, save=False):
    ...
    return sort_errors(concat_errors(punctuation_errors + capitalization_errors + tense_errors))
...
#message = "Jeg lytte til musik mens jeg arbejde."
...
#print(*errors1, sep="\n")
#pos = tagger.get_tags(message)[0]
#errors = tense_corrector.correct_tense(message, pos)
#print(errors)
#print(check_if_index_is_correct(errors, message))
